...
(0, _roads.show)(possibleRoutes("Point Teohotepapapa", "Point Kiukiu").length);
(0, _roads.show)(possibleRoutes("Point Teohotepapapa", "Point Kiukiu"));
(0, _roads.show)(possibleRoutes("Hanapaoa", "Mt Ootua"));