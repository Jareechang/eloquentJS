...
var countAncestors = function countAncestors(person, test) {
    var combine = function combine(current, mother, father) {
...
var longLivingPercentage = function longLivingPercentage(person) {
